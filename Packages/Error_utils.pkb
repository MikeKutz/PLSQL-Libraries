...
as
    ...
    begin
        return true;
        case
            when runtime.get_string( MKLibrary.Constants.param_log_level ) = MKLibrary.Constants.log_level_off
            then
                return false;
            when runtime.get_string( MKLibrary.Constants.param_log_level ) = MKLibrary.Constants.log_level_debug
            then
                return true;
            when runtime.get_string( MKLibrary.Constants.param_log_level ) =  MKLibrary.Constants.log_level_on
    ...
    begin
        ...
        then
            ...
            then
              ...
              MKLibrary.CLOB_utils.indent_block(log_entry); -- found in output_t
...
--            if runtime.get_boolean( MKLibrary.Constants.param_logging_output )
            if false
            then
